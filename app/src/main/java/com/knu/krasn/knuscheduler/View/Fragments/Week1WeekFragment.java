...
public class Week1WeekFragment extends Fragment implements BaseWeekFragment {
    ...
    public Week1WeekFragment() {
    }

    public static Week1WeekFragment newInstance() {
        Bundle args = new Bundle();
        args.putInt(ARG_SECTION_NUMBER, 1);
        Week1WeekFragment sampleFragment = new Week1WeekFragment();
